...
class Users(UserMixin, db.Model):
    ...
    user_id = db.Column(db.String(225), primary_key=True, nullable=False,
...
class Module(db.Model):
    ...
    module_id = db.Column(db.Integer, unique=True,
...
class Permissions(db.Model):
    ...
    accesses = db.relationship(
        'Accesses', back_populates='permission', lazy=True)
...
class UserAccess(db.Model):
    ...
    user = db.relationship('Users', back_populates='user_accesses')
